  ...
  */
  public function init() {
	...
	function enqueue_admin_styles() {
		...
		wp_enqueue_style( 'prdwc-admin-style', plugin_dir_url(__DIR__) . 'admin/admin.css', [], PRDWC_VERSION . time() );
	}

	function enqueue_public_scripts() {
		wp_enqueue_style( 'prdwc-style', plugin_dir_url(__DIR__) . 'public/public.css', [], PRDWC_VERSION . time() );
	}
